    ...
    >
      ...
      <div className="mb-8">
        ...
        <div className="mb-8">
          ...
          {/* EnhancedJigsawPuzzle demo removed - CodeCanyon system will be added */}
          <div className="bg-puzzle-black/30 border border-puzzle-aqua/20 p-8 rounded-lg text-center">
            <p className="text-muted-foreground">Puzzle demo will be available with the CodeCanyon system</p>
          </div>
        </div>
