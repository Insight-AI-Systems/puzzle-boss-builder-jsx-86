      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <ConceptItem 
              icon={<MoveHorizontal size={36} />}
              title="Skill-Based Competitions"
              description="Compete in various puzzle types that test your logical thinking, pattern recognition, and problem-solving abilities."
            />
            
            <ConceptItem 
              icon={<Clock size={36} />}
              title="Race Against Time"
              description="Complete puzzles as quickly as possible to earn a higher ranking on the leaderboard."
            />
            
            <ConceptItem 
              icon={<Award size={36} />}
              title="Premium Brand Prizes"
              description="Win high-quality products from top brands like Apple, Samsung, Sony, Nintendo, and more."
            />
          </div>
        </div>
      </div>
