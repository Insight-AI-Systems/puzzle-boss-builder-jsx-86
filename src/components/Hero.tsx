...
export const Hero = () => {
  ...
  return <div className="relative bg-black overflow-hidden">
      ...
      <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
        <img className="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src="/lovable-uploads/4fbf2007-dfbf-4bcf-ad58-e2f950b412cd.png" alt="Partially assembled dollar bill puzzle" />
      </div>
