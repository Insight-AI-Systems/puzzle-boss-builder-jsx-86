...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      "border-puzzle-aqua/50",
      "data-[state=checked]:bg-puzzle-aqua data-[state=unchecked]:bg-black/50",
      "hover:border-puzzle-aqua",
      className
    )}
    {...props}
    ref={ref}
  >
    <SwitchPrimitives.Thumb
      className={cn(
        ...
        "data-[state=checked]:bg-white data-[state=unchecked]:bg-gray-200"
      )}
    />
  </SwitchPrimitives.Root>
))
