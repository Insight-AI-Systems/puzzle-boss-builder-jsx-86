-- Apply existing migration files that were created
...
-- Add RLS policies for partner_products
...
CREATE POLICY "Public can view published partner products" ON partner_products
